package net.alpha.velocity.configuration;

import net.alpha.velocity.spring.support.VelocityEngineFactory;
import net.alpha.velocity.spring.support.VelocityEngineFactoryBean;
import net.alpha.velocity.spring.web.VelocityConfig;
import net.alpha.velocity.spring.web.VelocityConfigurer;
import net.alpha.velocity.spring.web.VelocityViewResolver;
import net.alpha.velocity.view.EmbeddedVelocityLayoutToolboxView;
import net.alpha.velocity.view.EmbeddedVelocityLayoutViewResolver;
